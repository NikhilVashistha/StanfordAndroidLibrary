...
public final class Version {
    ...
    private static final String LIBRARY_VERSION = "2017/02/27 10:02am";
    ...
    public static void main(String[] args) {
        ...
        if (printVersionOnly) {
            ...
            System.out.println("Stanford SimpleFirebase Library, by Marty Stepp (stepp AT cs DOT stanford DOT edu)");
